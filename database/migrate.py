...
def _import_models() -> "list[object]":
    ...
    Вернём объект модуля models, если у него есть свой Base.
    """
    modules: list[object] = []
    candidates: Sequence[str] = (
        "database.models",              # общий файл
...
async def migrate() -> None:
    ...
    # Собираем все возможные metadata, на всякий случай (если в проекте 2 разных Base)
    ...
    async with engine.begin() as conn:
        ...
        # 2) Инспекция (sync) — проверим users/settings и дольём недостающие колонки/строки
